        ...
        <Sheet open={isOpen} onOpenChange={onClose}>
            <SheetContent side="left" className="w-64 p-4">
                ...
                <ul className="menu menu-vertical mt-4 space-y-2">
                    ...
                    <li>
                        <Link href="/chatbot" className={`hover:text-primary font-semibold dark:hover:text-accent flex items-center gap-2
                            ${pathname === '/chatbot' ? 'font-bold text-primary dark:text-accent' : 'text-slate-800 dark:text-slate-300'}`} onClick={onClose}>

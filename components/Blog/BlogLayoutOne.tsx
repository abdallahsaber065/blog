...
const BlogLayoutOne = ({ post }: BlogLayoutOneProps) => {
  return (
    <Card className="group inline-block overflow-hidden border-none shadow-md hover:shadow-lg transition-shadow">
      <div className="relative">
        ...
        <CardContent className="w-full absolute bottom-0 p-4 xs:p-6 sm:p-10 z-20">
          {post.category && (
            <Tag

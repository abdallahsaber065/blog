...
export const SunIcon = ({ className, ...rest }: IconProps & React.SVGProps<SVGSVGElement>) => (
  <svg
...
export const MoonIcon = ({ className, ...rest }: IconProps & React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
...
export const LinkedinIcon = ({ className, ...rest }: IconProps & React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={42}
...
export const TwitterIcon = ({ className, ...rest }: IconProps & React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={42}
...
export const GithubIcon = ({ className, ...rest }: IconProps & React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={42}
...
export const SearchIcon = ({ className, ...rest }: IconProps & React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
...
export const CloseIcon = ({ className, ...rest }: IconProps & React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
...
export const MenuIcon = ({ className, ...rest }: IconProps & React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"

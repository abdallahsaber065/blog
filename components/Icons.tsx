...
export const SunIcon = ({ className, ...rest }: SunIconProps & React.SVGProps<SVGSVGElement>) => (
  <svg
...
export const MoonIcon = ({ className, ...rest }: SunIconProps & React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
...
export const LinkedinIcon = ({ className, ...rest }: SunIconProps & React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={42}
...
export const TwitterIcon = ({ className, ...rest }: SunIconProps & React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={42}
...
export const GithubIcon = ({ className, ...rest }: SunIconProps & React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={42}
...
export const DribbbleIcon = ({ className, ...rest }: SunIconProps & React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={42}

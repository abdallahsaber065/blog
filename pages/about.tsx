    ...
    <main className="flex flex-col items-center justify-between w-full">
      ...
      <div className="min-h-screen bg-base-100 py-16 px-4">
        ...
        <section className="container mx-auto text-center mb-16">
          <h1 className="text-4xl font-bold text-primary mb-4">About Dev Trend</h1>
        ...
        {/* Team Section */}
        <section className="container mx-auto text-center mb-16">
          <h2 className="text-3xl font-bold mb-8 text-primary">Meet Our Team</h2>
          <div className="flex flex-col md:flex-row items-center md:space-x-8 bg-base-100 shadow-lg hover:shadow-xl transition-shadow rounded-lg">
            ...
            <div className="p-4 text-left">
              <h3 className="text-xl font-semibold text-primary">Abdallah Saber</h3>
              <p className="text-base-content">Founder & Editor-in-Chief</p>
        ...
        <p className="text-base-content max-w-xl mx-auto mb-4">

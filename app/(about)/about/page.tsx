...
const AboutPage = () => {
  return (
    <div className="min-h-screen bg-light dark:bg-dark py-16 px-4">
      ...
      <section className="container mx-auto text-center mb-16">
        <div className="flex flex-col md:flex-row items-center md:space-x-8">
          <div className="flex-1">
            ...
            <Link href="/contact">
              <button className="bg-accent dark:bg-accentDark text-light dark:text-dark py-2 px-4 rounded">Contact Us</button>
            </Link>
          </div>
      ...
      <section className="container mx-auto text-center mb-16">
        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-8 bg-light dark:bg-dark shadow-lg hover:shadow-xl transition-shadow rounded-lg">
          ...
          <div className="p-4 text-left">
            ...
            <p className="text-gray-600 dark:text-white">Founder & Editor-in-Chief</p>
      ...
      {/* Join Us Section */}
      {/* <section className="container mx-auto text-center mb-16">
        <h2 className="text-3xl font-bold mb-4 text-accent dark:text-accentDark">Join Our Community</h2>
        <p className="text-gray-600 dark:text-white max-w-xl mx-auto mb-4">
        ...
        <Link href="/signup">
          <button className="bg-accent dark:bg-accentDark text-light dark:text-dark py-2 px-4 rounded">Register Now</button>
        </Link>
      </section> */}
    </div>
  );
